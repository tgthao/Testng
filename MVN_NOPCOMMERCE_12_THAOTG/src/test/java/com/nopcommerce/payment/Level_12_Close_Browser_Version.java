...
public class Level_12_Close_Browser_Version extends AbstractTest {
	...
	@BeforeClass
	public void beforeClass(String browserName,String version) {
		driver = OpenMultiBrowsers01(browserName,version);
