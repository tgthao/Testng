...
public class SnapDeal {
	 ...
	 * ".product_grid_row:nth-of-type(1)>div:nth-child(1)";
	 * driver.findElement(By.cssSelector(css)).click(); }
	 * 
	 * @Test public void buyAndRemoveFromCart() {
	 * 
	 ...
	 * 
	 * driver.findElement(By.cssSelector("i[title='Delete Item']")).click(); Alert a
	 * = driver.switchTo().alert(); a.accept(); }
	 * 
	 * @Test public void logout() {
	 * 
	 * driver.findElement(By.linkText("START SHOPPING NOW")).click(); Actions s =
	 * new Actions(driver); WebElement user =
